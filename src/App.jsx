  ...
  return (
    <>
      <div className="w-full flex flex-col justify-center items-center my-5">
        ...
        <div className="w-96 bg-gray-300 h-10 rounded-2xl relative" style={{ overflow: "hidden" }}>
          <p className="relative text-center pt-2 z-10 font-bold" style={{ overflow: "hidden" }}>{progress}% </p>
